...
artists_to_shows__assoc_table = db.Table('artists_shows',
...
class Artist(db.Model):
    ...
    seeking_description = (db.String(500))
    upcoming_shows = db.relationship('Show', secondary=artists_to_shows__assoc_table,
      backref=db.backref('artists', lazy=True))
    past_shows = db.relationship('Show', secondary=artists_to_shows__assoc_table,
      backref=db.backref('artists', lazy=True))
    past_shows_count = db.Column(db.Integer)
    upcoming_shows_count = db.Column(db.Integer)
